...
@testset "ShapiroWilk" begin
    @testset "ShapiroWilkCoefs" begin
        ...
        S = HypothesisTests.ShapiroWilkCoefs(10)
        @test length(S) == 10
        @test lastindex(S) == 10
        @test length(S.A) == 5
        ...
        S = HypothesisTests.ShapiroWilkCoefs(11)
        @test length(S) == 11
        @test lastindex(S) == 11
        @test length(S.A) == 5
        ...
        #anti-symmetry
        S = HypothesisTests.ShapiroWilkCoefs(20)
    ...
    @testset "ShapiroWilk" begin
        ...
        @test_throws ArgumentError ShapiroWilkTest([1, 2, 3], uncensoredN=4)
